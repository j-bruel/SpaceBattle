//!
//! @file BufferDataManager.hpp
//! @author jbruel
//! @date 10/11/18
//!

#ifndef SPACEBATTLE_CLIENT_TOOLS_BUFFERDATEMANAGER_HPP
# define SPACEBATTLE_CLIENT_TOOLS_BUFFERDATEMANAGER_HPP
...
namespace tool
{
    ...
    //!
    template <class T>
    class   BufferDataManager : public Subject<BufferDataManager<T>>, public commun::tool::Singleton<BufferDataManager<T>>
    {
        friend class commun::tool::Singleton<BufferDataManager<T>>; //!< Allow current class to become singleton.
    ...
    public:
        ...
        //!
        inline size_t size() const { return (mQueue.size()); }
...
# include "Tools/BufferDataManager.cpp"

#endif //SPACEBATTLE_CLIENT_TOOLS_BUFFERDATEMANAGER_HPP

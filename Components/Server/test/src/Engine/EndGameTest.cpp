...
//!
//! @test Check the end game with WIN and LOOSE status.
//!
TEST (EndGame, PlayerWin)
{
    ...
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(0);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 0 shoot ship 80
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 0);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(80);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(0);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 0 shoot ship 81
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 0);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(81);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(0);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 0 shoot ship 15
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 0);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(15);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(0);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 0 shoot ship 25
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 0);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(25);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(0);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 0 shoot ship 35
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 0);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(35);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(0);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 0 shoot ship 16
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 0);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(16);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(0);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 0 shoot ship 26
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 0);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(26);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(0);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 0 shoot ship 36
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 0);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(36);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(0);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 0 shoot ship 51
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 0);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(51);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    ...
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(0);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 0 shoot ship 53
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 0);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(53);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(0);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 0 shoot ship 54
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 0);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(54);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(0);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 0 shoot ship 74
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 0);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(74);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(0);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 0 shoot ship 75
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 0);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(75);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(0);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 0 shoot ship 76
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 0);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(76);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(0);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 0 shoot ship 77
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 0);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(77);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(0);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 0 shoot ship 78
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 0);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    std::dynamic_pointer_cast<spcbttl::commun::net::req::ShootShipReq>(packet12.mPacketBody)->setShootPos(78);
    rmm.execute(std::make_shared<spcbttl::commun::net::Packet>(packet12));
    //    user_id 1 shoot ship 0
    packet12.setHeader(spcbttl::commun::net::req::SHOOT_SHIP_REQ, 1);
    packet12.mPacketBody = std::make_shared<spcbttl::commun::net::req::ShootShipReq>();
    ...
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :1 case :0 status :2") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :0 case :80 status :0") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :1 case :0 status :2") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :0 case :81 status :1") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :1 case :0 status :2") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :0 case :15 status :0") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :1 case :0 status :2") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :0 case :25 status :0") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :1 case :0 status :2") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :0 case :35 status :1") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :1 case :0 status :2") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :0 case :16 status :0") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :1 case :0 status :2") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :0 case :26 status :0") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :1 case :0 status :2") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :0 case :36 status :1") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :1 case :0 status :2") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :0 case :51 status :0") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :1 case :0 status :2") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    ...
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :0 case :53 status :0") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :1 case :0 status :2") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :0 case :54 status :1") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :1 case :0 status :2") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :0 case :74 status :0") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :1 case :0 status :2") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :0 case :75 status :0") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :1 case :0 status :2") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :0 case :76 status :0") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :1 case :0 status :2") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :0 case :77 status :0") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :1 case :0 status :2") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: shoot_ship Done. player :0 case :78 status :1") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 turn.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 0 win.") != std::string::npos);
    EXPECT_TRUE(outStdout.find("Room: Player 1 loose.") != std::string::npos);
